...
If you are using a ZSH framework like [zgenom](https://github.com/jandamm/zgenom) or [oh-my-zsh](https://ohmyz.sh), refer to [Zsh plugin suppport for diff-so-fancy](https://github.com/so-fancy/diff-so-fancy/blob/next/pro-tips.md#zsh-plugin-suppport-for-diff-so-fancy) for detailed installation instructions.
