...
@test "diff-highlight resolved when already on path" {
  ...
  run printf "%s" "$lines"
  assert_line --partial --index 21 'eval [m[1;31;48;5;52m"env CLICOLOR_FORCE=1 command $ls $param [m[1;31m$argv"[m'
  assert_line --partial --index 22 'eval [m[1;32;48;5;22m$ls $param "[m[1;32m$argv"[m'
}
